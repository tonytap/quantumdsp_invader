	...
	public:
		...
		static AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
		{
			return AudioProcessorValueTreeState::ParameterLayout{
                ...
                std::make_unique<AudioParameterFloat>("eq2", "eq2", NormalisableRange<float>{-6.f, 6.f, 0.1f}, 0.9000000953674316f),
                std::make_unique<AudioParameterFloat>("eq1", "eq1", NormalisableRange<float>{-6.f, 6.f, 0.1f}, 1.400000095367432f),
                std::make_unique<AudioParameterFloat>("reverb", "Reverb", NormalisableRange<float>{0.f, 1.f, 0.01f}, 0.2599999904632568f),
                ...
                std::make_unique<AudioParameterFloat>("noise gate", "Noise Gate", NormalisableRange<float>{-100.f, 0.f, 0.1f}, -72.40000152587891f),
