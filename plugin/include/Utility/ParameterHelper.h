	...
	public:
		...
		static AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
		{
			return AudioProcessorValueTreeState::ParameterLayout{
				std::make_unique<AudioParameterFloat>("input gain", "Input Gain", NormalisableRange<float>{-20.f, 20.f, 0.1f}, 0.8000003099441528f),
				std::make_unique<AudioParameterFloat>("output gain", "Output Gain", NormalisableRange<float>{-20.f, 20.f, 0.1f}, 2.980232238769531e-7f),
                std::make_unique<AudioParameterFloat>("eq2", "eq2", NormalisableRange<float>{-6.f, 6.f, 0.1f}, -0.7999999523162842f),
                std::make_unique<AudioParameterFloat>("eq1", "eq1", NormalisableRange<float>{-6.f, 6.f, 0.1f}, 1.200000047683716f),
                std::make_unique<AudioParameterFloat>("reverb", "Reverb", NormalisableRange<float>{0.f, 1.f, 0.01f}, 0.0f),
                ...
                std::make_unique<AudioParameterFloat>("amp gain", "Amp Gain", NormalisableRange<float>{1.f, 10.f, 0.1f}, 6.0f),
                ...
                std::make_unique<AudioParameterInt>("ir selection", "IR Selection", 0, Constants::NUM_IRS, 6),
                ...
                std::make_unique<AudioParameterFloat>("noise gate", "Noise Gate", NormalisableRange<float>{-100.f, 0.f, 0.1f}, -80.0f),
